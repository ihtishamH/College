<?php include "header.php"; ?>
	...
	<!-- Start About -->
	<div class="about-section-box" style="color: black;">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>College Canteen</span></h1>
						<p>Canteen is situated with in JIST campus. The canteen reflects the value habits of putting on healthy eating practices to the pupils and teachers alike. In addition to providing nutritious food, the canteen is important to health in promoting its role within the college. For pupils who use canteen services regularly, the food purchased there makes a significant contribution to their total daily food intake and nutrition. </p>
						
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<img src="images/jist-canteen.webp" style="height: 450px; width: 100%" class="img-fluid">
				</div>
				<div class="col-md-12">
					<div class="inner-pt">
						<p>
						We believe that food should be made to cultivate the mind and enrich the soul; to incite conversation and to inspire acclaim; to provide joy and celebrate life! With this philosophy in mind, we focus on locally sourced ingredients to ensure the highest quality and most flavorful food year round. 
						</p>
